...
public class TransparentImages {
        public static void main(String[] args) throws IOException {
                ...
                // to be black
                System.out.println(
                                "Distance between transparent images" + hashes[0].normalizedHammingDistance(hashes[1]));
                ...
                // The second hashing algorithm correctly computes the values for the
                // transparent images.
                ...
                try {
                        ...
                        System.out.println(
                                        "The hashes of both algorithms are not compatible as they might produce different hashes for the same input.");
                }
